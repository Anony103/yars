      ...
      <div className="flex flex-col gap-4">
        <div className="w-full md:w-1/4">
          <select
            ...
            className="w-full font-jakarta-sans font-normal border border-[#E1DFDF] text-sm py-2 px-2 rounded-lg focus:outline-none"
          >
        ...
        <div className="flex flex-col gap-4 w-full md:full">
          <div className="flex flex-col gap-2">
            ...
            <div className="bg-gray-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
